...
export declare class RouteVersionsCollection extends Collection<RouteVersion, RouteVersionProps> {
    constructor(props?: RouteVersionsCollectionProps);
    /**
     * @param - données en "style" oir, telles qu'obtenues de OIG-OIR-to-JSON
     */
    static createFromOirStyleData(oirStyleData: any): RouteVersionsCollection;
    generateOirStyleData(): {
        route_version: RouteVersion[];
        route: Route[];
    };
    getRouteVersionByIdentifier(rtevIdentifier: string): RouteVersion;
