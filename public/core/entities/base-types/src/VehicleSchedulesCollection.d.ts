import { Collection, ExtendedCollectionProps, CollectionAssociationType } from "@bimo/core-utils-collection";
...
export declare class VehicleSchedulesCollection extends Collection<VehicleSchedule, VehicleScheduleProps> {
    libelle: string;
    links: any[];
    _tripsCollectionOfAllTripsOfAllVscs: any;
    constructor(props?: VehicleSchedulesCollectionProps);
    static createFromOirStyleData(oirStyleData: any, libelle: string, associationType?: CollectionAssociationType): VehicleSchedulesCollection;
    ...
    getOrCreateVehicleScheduleByVscName(vscName: string, defaultPropsForNewVsc: VehicleScheduleProps): VehicleSchedule;
    getVehicleScheduleByVscName(vscName: string): VehicleSchedule;
    /**
     ...
     */
    mergeWithOtherVscColl(otherVscColl: VehicleSchedulesCollection): VehicleSchedulesCollection;
    /**
