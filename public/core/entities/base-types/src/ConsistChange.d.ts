...
export declare class ConsistChange extends Item<ConsistChange> implements BlockActivityItem<ConsistChange> {
    cchgActivity?: string;
    _cchgInternalNumber?: string;
    _cchgBuildTime?: string;
    cchgEvent?: string;
    ...
    get cchgBuildTime(): string;
    set cchgBuildTime(v: string);
