...
export declare class Route extends Item<Route> {
    ...
    getVariantsThatUseOneOfThesePlaces(listOfPlaces: string | Set<string> | string[]): import("./Variant").Variant[];
    getVariantById(variantId: any): import("./Variant").Variant;
    get routeVersion(): RouteVersion;
}
