 ...
 */
export interface TripOrVariantSectionProps<PointType extends ExtendedItem<PointType>, PointProps extends ExtendedItemProps> extends ExtendedItemProps {
    points: TripOrVariantPoint<PointType, PointProps>[];
}
export declare class TripOrVariantSection<PointType extends TripOrVariantPoint<PointType, PointProps>, PointProps extends ExtendedItemProps, TripOrVariantType extends ExtendedItem<TripOrVariantType>, TripOrVariantProps extends ExtendedItemProps> extends Item<TripOrVariantSection<PointType, PointProps, TripOrVariantType, TripOrVariantProps>> {
    points: TripOrVariantPoint<PointType, PointProps>[];
    ...
    get tripOrVariant(): TripOrVariant<TripOrVariantType, TripOrVariantProps, PointType, PointProps>;
