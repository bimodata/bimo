...
export declare class Trip extends TripOrVariant<Trip, TripProps, TripPoint, TripPointProps> implements BlockActivityItem<Trip> {
    _bimoId: string | null;
    trpNumber: string;
    trpIsProtected?: string;
    trpRoute?: string;
    ...
    constructor(props: TripProps, context: BimoContext, tripOrVariantType?: TripOrVariantTypeEnum);
    /** en km */
    ...
    getTimeDiffInSecondsBetweenTripPointIndexes(indexOfFirst: number, indexOfSecond: number): any;
