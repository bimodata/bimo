...
export declare class VehicleSchedule extends VehicleScheduleOrRouteVersion<VehicleSchedule, VehicleScheduleProps> {
    vscName?: string;
    vscScenario?: string;
    vscSchedType?: string;
    vscBooking?: string;
    ...
    getTripByTripNumber(tripNumber: string): Trip;
    get computedVehicleTaskObjects(): {
        vehicleTasks: VehicleTasksCollection;
        setOfVtasByBlock: Map<import("./Block").Block, Set<import("./VehicleTask").VehicleTask>>;
        setOfVtasByBlockActivity: Map<BlockActivity, Set<import("./VehicleTask").VehicleTask>>;
        blocksAndActsAndSectionsByVta: Map<import("./VehicleTask").VehicleTask, import("./subs/computeVehicleTasksOfVsc").BlocksAndActsAndSections>;
        setOfBlockSectionsByBlockActivity: Map<BlockActivity, Set<import("./BlockSection").BlockSection>>;
    };
    get computedActivityEntityItemObjects(): {
        setOfBlockActivitiesByBlockActivityEntityItem: Map<any, any>;
        activityEntityItemByBlockActivity: Map<BlockActivity, import("./BlockActivityItem").BlockActivityItem<BaseBlockActivityItem>>;
    };
    get vehicleTasks(): VehicleTasksCollection;
    get setOfVtasByBlock(): Map<import("./Block").Block, Set<import("./VehicleTask").VehicleTask>>;
    get setOfVtasByBlockActivity(): Map<BlockActivity, Set<import("./VehicleTask").VehicleTask>>;
    get setOfBlockSectionsByBlockActivity(): Map<BlockActivity, Set<import("./BlockSection").BlockSection>>;
    get activityEntityItemByBlockActivity(): Map<BlockActivity, import("./BlockActivityItem").BlockActivityItem<BaseBlockActivityItem>>;
    ...
    get blocksAndActsAndSectionsByVta(): Map<import("./VehicleTask").VehicleTask, import("./subs/computeVehicleTasksOfVsc").BlocksAndActsAndSections>;
