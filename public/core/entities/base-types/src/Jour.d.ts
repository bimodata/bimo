...
export type JourFR0 = "Lundi" | "Mardi" | "Mercredi" | "Jeudi" | "Vendredi" | "Samedi" | "Dimanche";
export type JourFR1 = Lowercase<JourFR0>;
export type JourFR2 = "lu" | "ma" | "me" | "je" | "ve" | "sa" | "di";
export type JourEN0 = "Monday" | "Tuesday" | "Wednesday" | "Thursday" | "Friday" | "Saturday" | "Sunday";
...
export type JourValue = JourId | JourFR0 | JourFR1 | JourFR2 | JourEN0 | JourEN1 | JourEN2 | VscSchedType;
export declare class Jour {
    ...
    EN2: JourEN2;
    vscSchedType: string;
    constructor(jourValue: Jour | JourValue | {
        FR0: JourFR0;
    });
    getNextJour(): Jour;
