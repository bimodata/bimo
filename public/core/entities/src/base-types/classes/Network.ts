...
export declare class Network extends Item<Network> {
    ...
    removeEdge(edge: NetworkEdge, options?: {
        removeNodes?: boolean;
        skipCacheUpdate?: boolean;
    }): void;
    removeEdges(arrayOrSetOfEdges: NetworkEdge[] | Set<NetworkEdge>, options?: {
        removeNodes?: boolean;
    }): void;
    removeNodes(arrayOrSetOfNodes: NetworkNode[] | Set<NetworkNode>, options?: {
        removeEdges?: boolean;
    }): void;
    /**
     ...
     */
    filterEdges(callback: (value: NetworkEdge, index: number, array: NetworkEdge[]) => boolean): NetworkEdge[];
    /**
     ...
     */
    filterNodes(callback: (value: NetworkNode, index: number, array: NetworkNode[]) => boolean): NetworkNode[];
    addEdge(edge: NetworkEdge, options?: {
        skipCacheUpdate?: boolean;
    }): NetworkEdge;
    hasEdge(edge: NetworkEdge): boolean;
    removeNode(node: NetworkNode, options?: {
        removeEdges?: boolean;
        skipCacheUpdate?: boolean;
    }): void;
    addNode(node: NetworkNode, options?: {
        skipCacheUpdate?: boolean;
    }): NetworkNode;
