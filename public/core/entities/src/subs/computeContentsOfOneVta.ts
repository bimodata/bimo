...
function computeContentsOfOneVta(
  { vehicleTask, setOfVtasByBlock, setOfVtasByBlockActivity, setOfBlockSectionsByBlockActivity },
  { BlocksCollection, BlockActivitiesCollection, BlockSectionsCollection },
) {
